...
/**
 * Legacy/plain deep link: `/requests/day-changes/<id>?n=<id>`.
 *
 ...
 * and the page live.
 */
export const Route = createFileRoute('/_authenticated/requests/day-changes/$id')({
  ...
  beforeLoad: ({ params, search }) => {
    ...
    throw redirect({
      to: '/requests/day-changes/detail',
      search: {
        data: encryptParams({
